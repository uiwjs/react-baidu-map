...
export default function (props = {} as UseOverviewMapControl) {
  ...
  ] = useState<BMap.OverviewMapControl>();
  ...
  useEventProperties<BMap.OverviewMapControl, UseOverviewMapControl>(
    overviewMapControl!,
    props,
    ['ViewChanged', 'ViewChanging'],
  );
  useProperties<BMap.OverviewMapControl, UseOverviewMapControl>(
    overviewMapControl!,
    props,
    ['Anchor', 'Offset', 'Size'],
  );
